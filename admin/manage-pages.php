                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <select name="menu1" onChange="MM_jumpMenu('parent',this,0)">
                                            <option value="" selected="selected" class="form-control">***Chọn***
                                            </option>
                                            <option value="manage-pages.php?type=terms">Chính sách</option>
                                            <option value="manage-pages.php?type=privacy">Điều khoản</option>
