...
<body>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr height="50">
                    <td colspan="2" class="fontkink2" style="padding-left:0px;">
                        <div class="fontpink2"> <b>Cập nhật phản hồi !</b></div>
                    </td>
    ...
    <tbody>
        ...
        <tr style=''>
            <td class="fontkink1">Phản hồi:</td>
        ...
        <?php } else { ?>
        <tr>
            <td class="fontkink1"><b>Phản hồi:</b></td>
            <td class="fontkink" align="justify"><?php echo htmlentities($result->AdminRemark);?></td>
        </tr>
        <tr>
            <td class="fontkink1"><b>Thời gian phản hồi:</b></td>
